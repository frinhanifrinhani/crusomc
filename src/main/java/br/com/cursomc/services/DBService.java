...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
			...
			Produto p4 = new Produto(null,"Mesa de ecritório",30.00);
			...
			Cliente cli1 = new Cliente(
					null,
					"Thiago Frinhani",
					"frinhani.frinhani@gmail.com",
					"12345678987",
					TipoCliente.PESSOAFISICA,
					bCriBCryptPasswordEncoder.encode("123"));
			cli1.getTelefones().addAll(Arrays.asList("44441111","88887777"));
			
			Cliente cli2 = new Cliente(
					null,
					"Thiago Frinhani 2",
					"frinhani.asd1@gmail.com",
					"12345678988",
					TipoCliente.PESSOAFISICA,
					bCriBCryptPasswordEncoder.encode("123"));
			cli1.getTelefones().addAll(Arrays.asList("44441112","88887772"));
